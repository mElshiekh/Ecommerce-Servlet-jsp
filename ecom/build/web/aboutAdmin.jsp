<%-- 
    Document   : aboutAdmin
    Created on : Feb 16, 2018, 3:11:25 PM
...
<html>
    ...
    <body>
                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav ">
                                <li ><a href="HomeAdmin" class="hyper "><span>Home</span></a></li>	
        ...
        <div class="banner-top">
            <div class="container">
                <h3 >About</h3>
                <h4><a href="HomeAdmin">Home</a><label>/</label>About</h4>
                <div class="clearfix"> </div>
            </div>
        </div>
         ...
         <div class="footer">
            ...
            <div class="container">
                ...
                <div class="footer-bottom">
                    <h2 ><a href="HomeAdmin"><b>T<br>H<br>E</b>Big Store<span>The Best Supermarket</span></a></h2>
