                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
                            <ul class="nav navbar-nav ">
                                ...
                                <li name="maxPBut" ><a class="hyper" ><span><input type="button" value="Search" onclick="searchP()" style="background: #fdb515; color: #FFFFFF; text-align: center;border: none; font-size: 1em; outline: none;cursor: pointer;" id="maxPBut" /></span></a></li>
                            </ul>   
                        ...
                        <%--<c:choose>--%>
                            <%--<c:when test="${user.id >=0}">--%>
                                <a href="Cart" ><span class="fa fa-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"></span></span></a>
                                    <%--</c:when>--%>
                                    <%--<c:otherwise>--%>
                                <a onclick="plzLogin()" ><span class="fa fa-shopping-cart my-cart-icon"><span class="badge badge-notify my-cart-badge"></span></span></a>
                            <%--</c:otherwise>--%>
                        <%--</c:choose>--%>
                                            ...
                                            <div class="col-m">								
                                                ...
                                                <div class="mid-1">
                                                    ...
                                                    <div class="add">
                                                        <c:choose>
                                                            <c:when test="${user.id >=0}">
                                                                <a href="AddToCart?prodId=${product.id}&quant=-1" class="btn btn-danger my-cart-btn my-cart-b " value="${product.id}"  id="${product.id}" data-id="${product.id}" data-name="${product.name}" data-price="${product.price}" data-quantity="1" data-image="images/of.png">Add to Cart</a>
                                                            </c:when>
                                                            <c:otherwise>
                                                                <a onclick="plzLogin()" class="btn btn-danger my-cart-btn my-cart-b " value="${product.id}"  id="${product.id}" data-id="${product.id}" data-name="${product.name}" data-price="${product.price}" data-quantity="1" data-image="images/of.png">Add to Cart</a>
                                                            </c:otherwise>
                                                        </c:choose>
