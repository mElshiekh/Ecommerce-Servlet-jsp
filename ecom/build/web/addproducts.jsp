...
<div class="banner-top">
	<div class="container">
		<h3 >Add Product</h3>
                <h4><a href="HomeAdmin">Home</a><label>/</label>Add product</h4> 
                <div class="clearfix"> </div>
	</div>
</div>
	...
	<div class="login">
		<div class="main-agileits">
				<div class="form-w3agile form1">
					<h3>Add Product</h3>
					<form action="addProductServ"   id="usrform" enctype="multipart/form-data" method="post">
                                                Product Name:
						<div class="key">
							<i  aria-hidden="true"></i>
                                                        <input type="text" maxlength="25" name="ProductName"  required="">
						       <div class="clearfix"></div>
						</div>
                                                Product Category:
						<div class="key">
							<i  aria-hidden="true"></i>
							<input  type="text" maxlength="14" name="ProductCategory"  required="">
							<div class="clearfix"></div>
						</div>
                                                Product Price:
						<div class="key">
							<i  aria-hidden="true"></i>
							<input  type="number" maxlength="7" name="ProductPrice" size="50" >
							<div class="clearfix"></div>
						</div>
                                            ...
                                            <div class="key">
							<i  aria-hidden="true"></i>
							<input  type="number" maxlength="7"  name="ProductQuantity" size="50"  required="">
							<div class="clearfix"></div>
						</div>
                                              Product Description:          
                                              
							
							<textarea name="ProductDescription" rows="4" cols="44"  form="usrform"></textarea>
