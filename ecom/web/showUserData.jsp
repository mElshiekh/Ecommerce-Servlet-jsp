...
<div class="banner-top">
	<div class="container">
            <h3 >User Data</h3>
                <h4><a href="HomeAdmin">Home</a><label>/</label>Orders History</h4> 
                <div class="clearfix"> </div>
	</div>
</div>
                ...
                <c:forEach items="${alls}" var="user">
                    <tr>
                        <td height="50"><c:out value="${user.userId}"/></td>
                        <td height="50"><c:out value="${user.prodId}"/></td>
                        <td height="50"><c:out value="${user.bQuantity}"/></td>
                        <td height="50"><c:out value="${user.date}"/></td>
